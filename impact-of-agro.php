                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            <div class="page-title-heading">
                                <h1 class="title">Impact Of Agro-preneurship</h1>
                        ...
                        <article class="post ttm-blog-single clearfix">
                            ...
                            <div class="ttm-post-featured-wrapper">
                                <div class="ttm-post-featured">
                                    <img class="img-fluid" src="images/blog/post-107.png" alt="post-05">
                                </div>
                            ...
                            <div class="ttm-blog-single-content">
                                <div class="entry-content">
                                    ...
                                    <p>Entrepreneur play a key role in any economy, using the skills andinitiative necessary to anticipate needs and bring good news ideas to market. Entrepreneurs who prove to be successful in taking on the risks of a startup are rewarded with profits, fame, and continued growth opportunities.</p>
                                    <p><strong>ROLE OF ENTREPRENEURS WITHIN THE ECONOMY</strong></p>
                                    <ul>
                                        <li><i class="fa fa-check"></i>Capital formulations: entrepreneurs mobilize the idle saving of the public through the issue of industrial securities.</li>
                                        <li><i class="fa fa-check"></i>Improvement of per capital income</li>
                                        <li><i class="fa fa-check"></i>Generation of employment</li>
                                        <li><i class="fa fa-check"></i>Improvement of the living standard</li>
                                    </ul>
                                    <p class="mb-30"><strong>ENTREPRENEURSHIP DEVELOPMENT</strong><br>This is a program, method or process that aims to identify,nurture, support and grow the talents in bigger level so that it brings new business leaders in the market to reduce unemployment, health educational, business, environmental problems. The goal is to improve the living, the economic, social standard thinking, and actions of people.</p>
                            
                                    <p><strong>ENTREPRENEURSHIP AND COMMUNITY DEVELOPMENT</strong><br>Today we hear a great deal about the economic impact of entrepreneurship .more companies are being started than before in history: new and emerging companies are the source of all net new jobs in our economy; women are starting firms at far faster than men; 70% of high school juniors and seniors want to start their own companies when they are out of school; 13 million – 25 million of you count part time entrepreneurs are now running their own business from home and so on.But I don’t want to talk about the economic impact of entrepreneurship as significant as it is. I want to focus instead on the social impact of entrepreneurship. Entrepreneurship is not just an economic phenomenon but it is a force that creates social value and a resource for community development.In building community we must present an insightful examination of the importance of community and a provocative analysis of the need that individuals have for identification with and empowerment within the communities in which we live. We must emphasizes that “where community exits it confers upon its members identity, a sense of belongings, a measure of security” not only on those who elect to start and grow enterprise, but also on those who join tem inthat effort and on the wider environment in which we operate.</p>
                                    <p class="mb-30">Entrepreneurship is not only an economic phenomenon. It is alsoa force for community health and well-being. It does confer “identity, a sense of belonging, a measure of security”.Many successful individuals that own a company today are now proud of being entrepreneurs, know where them and their associates fit, helps in rebuilding their communities and helping other feel a part of that renewal and making people they work with have safe in their own performance.I admire each of them as entrepreneurs and as community builders. By nurturing, supporting and accelerating entrepreneurship in our community we can help others do the same.</p>
                                    <!-- separator -->
                                    <div class="separator">

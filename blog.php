                        ...
                        <div class="col-lg-9 content-area">
                            ...
                            <article class="post ttm-blog-classic clearfix">
                                <div class="row slick_slider blog-slide" data-slick='{"slidesToShow": 1, "slidesToScroll": 1, "dots":false, "arrows":true, "autoplay":true, "infinite":true, "centerMode":false, "responsive": [{"breakpoint":500,"settings":{"slidesToShow": 1}}]}'>
                                    <div class="col-lg-12">
                                        <div class="">
                                            <img class="img-fluid" src="images/single-img-twentysix.jpg" alt="single-img-twentysix">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="">
                                            <img class="img-fluid" src="images/single-img-twentyseven.jpg" alt="single-img-twentyseven">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ttm-blog-classic-content">
                                    <div class="entry-content">
                                        <div class="ttm-post-catagory">
                                            <span><a href="blog.php">Recent</a></span>
                                        </div>
                                        <header class="entry-header">
                                            <h2 class="entry-title"><a href="pigs-for-wealth.php">Pigs For wealth</a></h2>
                                        </header>
                                        <div class="ttm-post-entry-header">
                                            <div class="post-meta">
                                                <span class="ttm-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published" datetime="2018-07-28T00:39:29+00:00">July 07, 2020</time></span>
                                            </div>
                                        </div>
                                        <div class="ttm-box-desc-text">
                                            <p>There is an increasing awareness of the pig farming business and it's profitable nature globally. 
                                            The once despised pork is gaining rapid acceptance in West African countries regardless...</p>
                                        </div>
                                        <div class="ttm-blogbox-desc-footer">
                                            <div class="ttm-blogbox-footer-readmore d-inline-block">
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-10" href="pigs-for-wealth.php">Read More <i class="ti ti-angle-double-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <article class="post ttm-blog-classic clearfix">
                                ...
                                <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                                    <div class="ttm-post-featured">
                                        <img class="img-fluid" src="images/blog/07.jpg" alt="post-02">
                                    </div>
                                ...
                                <div class="ttm-blog-classic-content">
                                    <div class="entry-content">
                                        ...
                                        <header class="entry-header">
                                            <h2 class="entry-title"><a href="impact-of-agro.php">Impact Of Agro-preneurship</a></h2>
                                        </header>
                                        <div class="ttm-post-entry-header">
                                            <div class="post-meta">
                                                <span class="ttm-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published" datetime="2018-07-28T00:39:29+00:00">July 13, 2020</time></span>
                                            </div>
                                        </div>
                                        <div class="ttm-box-desc-text">
                                            <p>Entrepreneur play a key role in any economy, using the skills and initiative necessary to anticipate needs and bring good news ideas to market. Entrepreneurs who prove to be successful in taking on the risks of a startup are rewarded with profits, fame, and continued growth opportunities...</p>
                                        </div>
                                        <div class="ttm-blogbox-desc-footer">
                                            <div class="ttm-blogbox-footer-readmore d-inline-block">
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-10" href="impact-of-agro.php">Read More <i class="ti ti-angle-double-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- ttm-blog-classic-content end -->
                            ...
                            <article class="post ttm-blog-classic clearfix">
                                ...
                                <div class="ttm-post-featured-wrapper ttm-featured-wrapper">
                                    <div class="ttm-post-featured">
                                        <img class="img-fluid" src="images/blog/06.jpg" alt="post-03">
                                    </div>
                                </div><!-- post-featured-wrapper end -->
                                <!-- ttm-blog-classic-content -->
                                <div class="ttm-blog-classic-content">
                                    <div class="entry-content">
                                        ...
                                        <div class="ttm-post-entry-header">
                                            <div class="post-meta">
                                                <span class="ttm-meta-line entry-date"><i class="fa fa-calendar"></i><time class="entry-date published" datetime="2018-07-28T00:39:29+00:00">July 20, 2020</time></span>
                                            </div>
                                        </div>
                                        <div class="ttm-box-desc-text">
                                            <p>Farming pigs is more challenging than farming other forms of livestock such as cattle or goats owing to the fact that they are more sensitive to the environment climate and require more attention. But on the other hand, if they are...</p>
                                        </div>
                                        <div class="ttm-blogbox-desc-footer">
                                            <div class="ttm-blogbox-footer-readmore d-inline-block">
                                                <a class="ttm-btn ttm-btn-size-sm ttm-btn-color-skincolor btn-inline ttm-icon-btn-right mt-10" href="raising-pigs.php">Read More <i class="ti ti-angle-double-right"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div><!-- ttm-blog-classic-content end -->
                    ...
                    <div class="row copyright">
                        <div class="col-md-12">
                            <div class="text-center">
                                <span>Copyright © <?php echo date ("Y");?>&nbsp;<a href="#">Bypork</a></span>
                            </div>
                        </div>
                    </div>
                </div>

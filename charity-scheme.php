                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            <div class="page-title-heading">
                                <h1 class="title">Our charity scheme</h1>
                    ...
                    <div class="col-lg-9 content-area order-lg-2">
                        ...
                        <div class="ttm-service-single-content-area">
                            ...
                            <div class="ttm-service-description">
                                <h4>We Give Back To Our Society</h4>
                                <p>Around 1 in 6 people living in Africa suffer protein deficiency in their diet, BYPORK is an initiative to combat protein deficiency in Africa by pooling resources from Africans to farm pigs and giving back 10% of every investment on our platform to the less/under privileged in our community.</p>
                    ...
                    <div class="col-lg-3 widget-area">
                        <aside class="widget widget-nav-menu">
                            <ul class="widget-menu">
                                <li><a href="pig-farming.php">Pig farming and processing</a></li>
                                <li class="active"><a href="charity-scheme.php">Our charity scheme</a></li>
                            </ul>
                        </aside>
                        ...
                        <aside class="widget widget-download">
                            <ul class="download">
                                ...
                                <li>
                                    <i class="fa fa-file-pdf-o"></i>
                                    <a href="byporkT&C.pdf" title="Download our terms and conditions">Terms and Conditions</a>
                                </li>
                            </ul>
                        </aside>
                            ...
                            <div class="widget contact-widget">
                                ...
                                <div class="social-icons circle social-hover">
                                    <ul class="list-inline">
                                        ...
                                        <li class="social-instgram"><a class=" tooltip-top" target="_blank" href="instagram.com/bypork" data-tooltip="instagram"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>

...
<p class="text-center"><?php echo date (" D M Y");?></p>
  ...
  <form id="survey-form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
    ...
    <div class="form-group">
      ...
      <input name="phone2" id="phone2" type="text" placeholder="" class="form-control" minlength="9" maxlength="13" size="14">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label id="name-label">Gold* </span></label>
      <small>Specify amount from 600000 - 2000000 </small>
      <input type="number" name="amount" id="amount" class="form-control" min="600000" max="2000000" maxlength="7" size="7" placeholder="700000" required> 
    </div>

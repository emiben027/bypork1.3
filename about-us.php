...
<body>
    ...
    <div class="page">
                                        ...
                                        <div class="topbar-right text-right">
                                            ...
                                            <div class="ttm-social-links-wrapper list-inline">
                                                <ul class="social-icons">
                                                    ...
                                                    <li><a href="instagram.om/bypork"><i class="fa fa-instagram"></i></a>
                                                    </li>
                                                    <li><a href="linkedin.com/bypork"><i class="fa fa-linkedin"></i></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex flex-row align-items-center">
                                        ...
                                        <div class="site-branding mr-auto">
                                            <a class="home-link" href="index.php" title="Bypork" rel="">
        ...
        <div class="site-main">
                        ...
                        <div class="col-lg-6">
                            <div class="ml-40">
                                ...
                                <div class="ttm_single_image-wrapper position-relative after-border style3">
                                    <img class="img-fluid" src="images/static-img.png" title="pigs" alt="pigs">
                                </div><!-- ttm_single_image-wrapper end -->
                                <div class="about-overlay-04">
                            ...
                            <div class="res-991-mt-50">
                                ...
                                <div class="section-title clearfix">
                                    <div class="title-header">
                                        <h5>About bypork</h5>
                                        <h2 class="title">Save Africa. Make lots of money.</h2>
                                    </div>
                                    <div class="heading-seperator">
                                        <span></span>
                                    </div>
                                </div><!-- section title end -->
                                <p>Bypork is an initiative to combat protein deficiency in Africa by engaging Africans in Pig-Farming and giving back 10% returns of every investment to the under privileged in the society.</p>
                                <p>
                                        ...
                                        <div class="ttm-processbox-wrapper">
                                            <div class="ttm-processbox text-center">
                                                <div class="ttm-box-image">
                                                    <img class="img-fluid" src="images/step-one.png" alt="step-one" title="step-one">
                                            ...
                                            <div class="ttm-processbox text-center">
                                                ...
                                                <div class="featured-content">
                                                    <div class="featured-title"><h5>We farm</h5></div>
                                                    <div class="ttm-box-description">We give the pigs a comfortable and nourishing treat by providing quality feeding, vaccination and proper animal care</div>
                                                </div>
                                            </div>
                                            <div class="ttm-processbox text-center">
                                                <div class="ttm-box-image">
                                                    <img class="img-fluid" src="images/step-three.png" alt="step-three" title="step-three">
                                                    <div class="process-num">
                                                        <span class="number">03</span>
                                                    </div>
                                                </div>
                                                <div class="featured-content">
                                                <div class="featured-title"><h5>We pay</h5></div>
                                                    <div class="ttm-box-description">We raise the pigs, sell them and you get high interest returns, without stress.</div>
                                                </div>
                                            </div>
                                            <div class="ttm-processbox text-center">
                                                <div class="ttm-box-image">
            ...
            <!-- team-section -->
            <section class="ttm-row third-team-section clearfix">
                <div class="container">
                    <div class="row"><!-- row -->
                        <div class="col-lg-12">
                            <!-- section title -->
                            ...
                            <div class="cta_wrapper">
                                <div class="ttm-quicklink-box">
                                   <div class="ttm-rightlink-box">
                                        ...
                                        <h5 class="custom-heading"><a href="faq.php"> FAQs <span class="ti ti-arrow-circle-right ttm-arrow-box"></span></a></h5>
                                  </div>    
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget contact-widget">
                                ...
                                <div class="social-icons circle social-hover">
                                    <ul class="list-inline">
                                        ...
                                        <li class="social-linkedin"><a class=" tooltip-top" target="_blank" href="linkedin.com/bypork" data-tooltip="LinkedIn"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>

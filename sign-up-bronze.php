...
<p class="text-center"><?php echo date (" D M Y");?></p>
  ...
  <form id="survey-form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
    ...
    <div class="form-group">
      ...
      <input name="tel" id="tel" type="text" placeholder="+2341234567890" class="form-control" minlength="9" maxlength="13" size="14" required>
    </div>
    <div class="form-group">
      <label id="email-label">Phone Number 2</label>
      <input name="phone2" id="phone2" type="text" placeholder="" class="form-control" minlength="9" maxlength="14" size="14" pattern="">
    </div>
    <div class="form-group">

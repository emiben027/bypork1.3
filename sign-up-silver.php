...
<div class="container">
  <header class="header">
    <h1 class="text-center" id="h11"><strong class="ttm-textcolor-skincolor fw-600">Bypork</strong></h1>
    <h3 class="text-center" id="h11">Save African. Make Lots Of Money.<strong class="ttm-textcolor-skincolor fw-600"></strong></h3>
    <p>
...
<p class="text-center"><?php echo date (" D M Y");?></p>
  ...
  <form id="survey-form" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
    ...
    <div class="form-group">
      ...
      <input name="tel" id="tel" type="text" placeholder="234-80-8002-7961" class="form-control" value="" size="14" minlength="9" maxlength="13" size="14" required>
    </div>
    <div class="form-group">
      <label id="email-label">Phone Number 2</label>
      <input name="phone2" id="phone2" type="text" placeholder="" class="form-control" maxlength="13" size="14">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="date" name="birthday" id="birthday" class="form-control" placeholder="" min="1951-01-01" max="2012-01-01" required>
    </div>
    
    <div class="form-group">
      <label id="name-label">Silver* </span></label>
      <small>Specify amount from 300000 - 599999</small>
      <input type="text" name="range" id="amount" class="form-control" value="<?php echo($_POST['amount']);?>" min="300000" max="599000" placeholder="300000" pattern="[3-6]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}[0-9]{1}" required> 
    </div>

    <div class="form-group">
      <label id="name-label">Bank Details*</label>
      <input type="text" name="account" id="name" class="form-control" placeholder="0012345678900" minlength="7"  maxlength="16" size="20" required>
      <dir></dir>
      <input type="text" name="bank" id="name" class="form-control" placeholder="enter your banking institution" value="" required> 
    </label>
    </div>
    <div>
   <label>
    ...
    <div class="form-group">
      <label>How Did You Hear About Us</label>
        <select type="text" name="channel" id="channel" class="form-control" placeholder="" value="">
           ...
           <option>Bypork Rep</option>
           <option>Friend</option>
        </select>
    </div>
    <div class="form-group">
      <input type="hidden" name="refnum" id="refid" class="form-control" placeholder="" value="<?php echo($_POST['refnum']);?>"> 
    </div>
    <div class="form-group">
      <input type="hidden" name="refid" id="refid" class="form-control" placeholder="" value="<?php echo($_POST['refid']);?>"> 
    </div>
    <div class="form-group">
      <input type="hidden" name="regdate" id="regdate" class="form-control" placeholder="" value=""> 
    </div>
    </div>

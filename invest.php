                                           ...
                                           <li><a href="about-us.php">About Us</a></li>
                                            <li><a href="">Services</a>
                                                <ul>
                                                    ...
                                                    <li><a href="investment-solution.php">Investment Solutions</a></li>
                                                    <li><a href="services-02.php">Our Charity Scheme</a></li>
                                                </ul>
                                            </li>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="section-title text-center clearfix">
                                <div class="title-header">
                                    ...
                                    <h6 class="title">10% of our every investment in form of pork  goes to the less privledged in our community.</h6>
                                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="section-title text-center clearfix">
                                <div class="title-header mb-50">
                                    ...
                                    <h2 class="title">Our Special Plans</h2>
                                </div>
                                <div class="heading-seperator">
                                    <span></span>
                                </div>
                    ...
                    <div class="row"><!-- row -->
                        <div class="col-lg-12">
                            <div class="mt-35 res-991-mt-10 text-center">
                                <h5>Two or three times a year, we may announce special plans, different from our standard plans and rates.</h5>
                                <h6 class="mb-0">You are adviced to check in regularly for those opportunities to maximize your investments as they return higher interest than regular plans. <a href="contact-us.php" class="ttm-textcolor-skincolor"> <u>Contact us </u></a></h6>
                            </div>
                        </div>
                    </div><!-- row end-->
                </div>
